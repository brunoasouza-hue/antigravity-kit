...
<head>
    ...
    <style>
        ...
        .home-card-icon-circle {
            ...
            font-size: 1.4rem;
            margin-bottom: 24px;
            box-shadow: 0 4px 10px rgba(252, 35, 35, 0.2);
        }
    ...
    <section class="sec-main">
        ...
        <div class="dashboard-container" style="margin-top: 30px;">
            ...
            <div style="margin-bottom: 35px;">
                <h2 style="font-family: 'TASA Orbiter', sans-serif; font-weight: bold; color: var(--corTxt3); font-size: 1.8rem;">Navegação Rápida</h2>
                <p style="color: var(--corTxt2); margin-top: 5px;">Escolha uma das ferramentas abaixo para iniciar suas atividades.</p>
            </div>
            ...
            <div class="home-cards-grid">
                ...
                <a href="./corretivas.php" class="home-card">
                    <!-- Ícone da chave (wrench) vermelho sem círculo, inclinado conforme imagem -->
                    <div class="home-card-icon-flat" style="color: #fc2323; transform: rotate(-45deg);">
                ...
                <?php if ($usuarioNivel === 'Gestor'): ?>
                    <a href="./ambientes.php" class="home-card">
                        <div class="home-card-icon-flat" style="color: #007bff;">
                    ...
                    <a href="./usuarios.php" class="home-card">
                        <div class="home-card-icon-flat" style="color: #28a745;">
                ...
                <!-- 5. Meu Perfil (Todos os usuários) -->
                <a href="./perfil.php" class="home-card">
                    <div class="home-card-icon-flat" style="color: #6c757d;">
                        <i class="bi bi-person-fill"></i>
                    </div>
